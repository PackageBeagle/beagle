...
// Returns nil if the file is missing, non-regular, unreadable, oversized, or
// unparseable — callers should treat nil as "unknown" and leave
// DirectDependency absent.
//
...
// a lockfile checked into a repo without a sibling package.json). Too-large
// files are already diag-warned once by fsread.Bounded; loadDirectDeps must
// not add a second warning for that case.
