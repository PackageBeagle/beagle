...
import (
	...
	"github.com/packagebeagle/beagle/internal/ecosystem/editorext"
	"github.com/packagebeagle/beagle/internal/ecosystem/gomod"
	"github.com/packagebeagle/beagle/internal/ecosystem/homebrew"
	"github.com/packagebeagle/beagle/internal/ecosystem/mcp"
	"github.com/packagebeagle/beagle/internal/ecosystem/npm"
	"github.com/packagebeagle/beagle/internal/ecosystem/pnpm"
	"github.com/packagebeagle/beagle/internal/ecosystem/pypi"
	"github.com/packagebeagle/beagle/internal/ecosystem/rubygems"
	"github.com/packagebeagle/beagle/internal/ecosystem/skills"
	"github.com/packagebeagle/beagle/internal/ecosystem/yarn"
	"github.com/packagebeagle/beagle/internal/exposure"
...
type Result struct {
	...
	Diagnostics              int
	TimedOut                 bool
	// Truncated is true whenever the scan did not run to completion:
	// either the --max-duration deadline was exceeded (in which case
	// TimedOut is also true) or the run context was cancelled, e.g. by a
	// SIGINT/SIGTERM handler in cmd/beagle. Callers must not report a
	// truncated run as status=complete.
	Truncated bool
