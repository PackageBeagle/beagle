...
// (https://ossf.github.io/osv-schema/) into Beagle exposure-catalog
...
type Options struct {
	// Ecosystems, when non-empty, restricts output to these Beagle
...
// the lowercased values Beagle emits on records, so a generated entry
// matches the scanner's output. Only the registries Beagle inventories
...
// mapEcosystem returns the Beagle ecosystem for an OSV ecosystem
