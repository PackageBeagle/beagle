// Command osvcatalog converts offline OSV data into a Beagle exposure
// catalog.
//
// It is a maintainer-side tool, not part of the shipped scanner: Beagle
...
// and is consumed by `beagle scan --exposure-catalog`.
package main
...
import (
	...
	"github.com/packagebeagle/beagle/internal/osv"
)
...
func run(args []string, stdout, stderr io.Writer) error {
	...
	ecoFlag := fs.String("ecosystem", "", "restrict to these Beagle ecosystems (comma-separated: npm,pypi,go,rubygems,packagist,editor-extension)")
	...
	fs.Usage = func() {
		fmt.Fprintf(stderr, "Usage: osvcatalog [flags] <path>...\n\n"+
			...
			"records are emitted. Beagle does not fetch OSV at scan time; download\n"+
